...
export const ja: Record<UiMessageKey, string> = {
  ...
  'health.noEngine':
    'Stockfish が見つからないか起動できませんでした。インストールしてから kibitz サーバーを再起動してください。',
  'health.unreachable':
  ...
  'settings.depth.hint':
    '2 手深くするごとに、棋譜全体の解析時間はおよそ 3 倍になります。次の解析から反映されます。',
